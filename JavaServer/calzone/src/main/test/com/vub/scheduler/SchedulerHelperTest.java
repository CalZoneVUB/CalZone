...
public class SchedulerHelperTest {
    ...
    @TestWith({
	    ...
	    "2014/1/10-12:00@2, 'Case 4, subcase 1: first class starts at noon and ends before noon.', 0",
	    ""})
    public void checkSpareHoursAndNoonBreak(List<Entry> entryList,
     ...
     */
    @Coercion
    public List<Entry> parseEntries(String entries) {
