...
public class RoomTypeCVTest extends ConstraintViolationTest {
	...
	public void roomTypeViolated() {
		...
		logEntries(RuleNames.roomTypeViolated, entryList);
		...
		assertTrue("No " + RuleNames.spareHoursViolated + " detected.",
				constraintNames
						.contains(RuleNames.roomTypeViolated));

		assertEquals("HardScore is not -1.", -1, ssc.getScore().getHardScore());
