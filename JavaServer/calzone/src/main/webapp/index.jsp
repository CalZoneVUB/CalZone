...
<html lang="en">
  ...
  <body>
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${pageContext.request.contextPath}/login/create"><spring:message code="login.SignUp.text" /></a></li>
							...
							<form class="navbar-form navbar-right" action="<c:url value='j_spring_security_check' />" method="post">
								<fieldset>
									...
									<div class="input-group" style="padding-bottom: 5px;">
										...
										<input type="text" name="j_username" class="form-control" placeholder='<spring:message code="login.placeHolderUsername.text"/>'>
									</div>
									<div class="input-group" style="padding-bottom: 5px;">
									...
									<input type="submit" class="btn btn-primary form-control" style="clear: left; width: 100%; height: 32px; font-size: 13px;" value="<spring:message code="login.login.text" />" />
									<p>
										<br>
			...
			<form id="target">
				<div class="btn-group " style="padding-bottom: 5px; width:100%;">
					<select id="ffac" class="form-control">
						...
						<option value="WE">Wetenschappen en Bio-ingenieurswetenschappen</option>
					</select>
				</div>
				...
				<button id="go_btn" type="submit" class="btn btn-primary form-control has-spinner" style="clear: left; width: 100%; height: 32px; font-size: 13px;">
				...
				<div class="agenda-wrapper">
					...
					<div class="agenda-events agenda-day1">
						...
						<span class="agenda-event anthracite-gradient from-10 to-13">
							...
							Kansrekening en statistiek (HOC)<br><br>
							G.1.022	- 22-29, 34<br>
							MAES DOMINIQUE
						</span>
	...
	<div class="container">
		<div class="row">
		  <div class="col-md-12 text-center"><p>&copy; Vrije Universiteit Brussel - Team CalZone</p></div>
		</div>
	</div>
	...
	<!-- Scripts -->
	<script src="${pageContext.request.contextPath}/themes/js/libs/setup.js"></script>
	<script src="${pageContext.request.contextPath}/themes/js/libs/agenda.js"></script>
