...
public class CourseTrajectAssociationID implements Serializable {
	...
	public int hashCode() {
		return (int)(courseID + trajectID);
	}

	public boolean equals(Object object) {
		if (object instanceof CourseTrajectAssociationID) {
			CourseTrajectAssociationID otherId = (CourseTrajectAssociationID) object;
			return (otherId.courseID == this.courseID) && (otherId.trajectID == this.trajectID);
		}
		return false;
	}
}
