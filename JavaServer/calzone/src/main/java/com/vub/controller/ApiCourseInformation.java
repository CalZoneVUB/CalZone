...
@Controller
public class ApiCourseInformation {
	/**
	 * 
	 ...
	 */
	@RequestMapping(value="/api/courseInformation", method = RequestMethod.POST)
    @ResponseBody
    ...
    //TODO make sure this checks whether a user has access to change data.
